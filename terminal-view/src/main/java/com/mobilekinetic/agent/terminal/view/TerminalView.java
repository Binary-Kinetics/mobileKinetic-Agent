package com.mobilekinetic.agent.terminal.view;
...
import com.mobilekinetic.agent.terminal.emulator.KeyHandler;
import com.mobilekinetic.agent.terminal.emulator.TerminalEmulator;
import com.mobilekinetic.agent.terminal.emulator.TerminalSession;
import com.mobilekinetic.agent.terminal.view.textselection.TextSelectionCursorController;
...
public final class TerminalView extends View {
     ...
     * {@link com.mobilekinetic.agent.terminal.emulator.TerminalSessionClient#onTerminalCursorStateChange(boolean)}
    ...
    protected void onDetachedFromWindow() {
        ...
        if (mTextSelectionCursorController != null) {
            ...
            // android.view.WindowLeaked: Activity com.mobilekinetic.agent.terminal.app.TermuxActivity has leaked window android.widget.PopupWindow
            stopTextSelectionMode();
